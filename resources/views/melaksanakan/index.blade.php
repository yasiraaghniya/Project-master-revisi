      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="date" name="tglawalmt" id="tglawalmt" class="form-control">
                </div>
    
                <div class="form-group">
                    <label for="label">Tanggal Akhir</label>
                    <input type="date" name="tglakhirmt" id="tglakhirmt" class="form-control">
                </div> 
        </div>
        <div class="modal-footer">
            <div class="form-group">
                <a href=""  onclick="this.href='/cetak-periode-melaksanakan-tugas/'+ document.getElementById('tglawalmt').value +
                    '/' + document.getElementById('tglakhirmt').value "target="_blank" class="btn btn-primary">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr align="left">
                    ...
                    <form action="{{ url('melaksanakan-tugas/' .$item->id) }}" method="post" class="d-inline" onsubmit="return confirm('Yakin Ingin Menghapus Data?')">
                            @method('delete')
                            @csrf
