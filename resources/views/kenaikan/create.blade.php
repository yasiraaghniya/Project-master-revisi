    ...
    <div class="animated fadeIn">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('kenaikan-gaji.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            {{-- {{csrf_field()}} --}}
                            ...
                            <div class="form-group">
                                ...
                                <select name="pegawaikgaji_id" class="form-control @error('pegawaikgaji_id') 
                                    ...
                                    <option value="{{ $item->id }}"
                                        {{ old('pegawaikgaji_id') == $item->id ?'selected' : null }}>
                            ...
                            <div class="form-group">
                                ...
                                <select name="pegawaikgaji_id" class="form-control @error('pegawaikgaji_id') 
                                    ...
                                    @foreach ($pegawais as $item)
                                    <option value="{{ $item->id }}"
                                        {{ old('pegawaikgaji_id') == $item->id ?'selected' : null }}>{{ $item->nip }}
                                    </option>
                                    @endforeach
                                </select>
                                @error('pegawaikgaji_id')
