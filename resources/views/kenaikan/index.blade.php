      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="date" name="tglawalkg" id="tglawalkg" class="form-control">
                </div>
    
                <div class="form-group">
                    <label for="label">Tanggal Akhir</label>
                    <input type="date" name="tglakhirkg" id="tglakhirkg" class="form-control">
                </div> 
        </div>
        <div class="modal-footer">
            <div class="form-group">
                <a href=""  onclick="this.href='/cetak-periode-kenaikan-gaji/'+ document.getElementById('tglawalkg').value +
                    '/' + document.getElementById('tglakhirkg').value "target="_blank" class="btn btn-primary">
            ...
            <tbody>
                ...
                <tr align="left">
                    ...
                    <td class="text-center">
                        ...
                        <a href="{{ url('kenaikan-gaji/' .$item->id. '/edit') }}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                        <a href="{{ url('kenaikan-gaji/' .$item->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-eye"></i></a>
                    <form action="{{ url('kenaikan-gaji/' .$item->id) }}" method="post" class="d-inline" onsubmit="return confirm('Yakin Ingin Menghapus Data?')">
                            @method('delete')
                            @csrf
