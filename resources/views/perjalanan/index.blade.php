            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        {{-- @endif --}}
                        <a href="{{ url('perjalanan-dinas/delete'.$item->id)}}" class="fa fa-close" onclick="return confirm('Yakin hapus permanen?')">
                                  
                                </a>
                        
                        <a href="{{ url('perjalanan-dinas/' .$item->id. '/edit') }}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                        <a href="{{ url('perjalanan-dinas/' .$item->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-eye"></i></a>
                    </td>
                </tr>
                @endforeach
                @else
